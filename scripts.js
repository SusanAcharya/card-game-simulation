...
const cards = [
    { name: 'Human', health: 100, damage: 20, healing: 5, speed: 10, image: 'images/human.png' },
    { name: 'Alien', health: 80, damage: 25, healing: 10, speed: 15, image: 'images/alien.png' },
    { name: 'Cyborg', health: 120, damage: 15, healing: 7, speed: 12, image: 'images/cyborg.png' },
    { name: 'Ghost', health: 90, damage: 18, healing: 7, speed: 11, image: 'images/ghost.png' },
    { name: 'Zombie', health: 110, damage: 22, healing: 5, speed: 13, image: 'images/zombie.png' },
    { name: 'Dino', health: 100, damage: 20, healing: 10, speed: 14, image: 'images/dino.png' }
];
...
const typeSynergyBoosts = {
    'Human': { health: 0.1, damage: 0.1, healing: 0.1, speed: 0 },
    'Alien': { health: 0.1, damage: 0.1, healing: 0.1, speed: 0 },
    'Cyborg': { health: 0.1, damage: 0.1, healing: 0.1, speed: 0 },
    'Ghost': { health: 0.1, damage: 0.1, healing: 0.1, speed: 0 },
    'Zombie': { health: 0.1, damage: 0.1, healing: 0.1, speed: 0 },
...
function showAnalytics() {
    ...
    if (currentWinner === 'Player') {
        ...
        analyticsMessage += `<p>You won, but here are scenarios where you could have lost:</p><ul>`;
        ...
        analyticsMessage += `<p>You lost, but here are scenarios where you could have won:</p><ul>`;
